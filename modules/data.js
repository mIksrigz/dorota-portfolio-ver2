export const videos = [
    {
        ...
        'description': `[Wanda Czełkowska, Andrzej Wojciechowski, Anna Jarnuszkiewicz+ Krystititan Jarnuszkiewicz, Stanisław Dróżdż, Jerzy Ludwiński, Otto Piene, Maria Pinińska-Bereś, Yaoji Kusama, Ayano Shibata, Jerzy Bereś, Micho Iwata, Ryszard Ługowski, Koji Kamoji, Małgorzata Sady, Bożena Biskupska, Katarzyna Podpora, Edka Jarząb, Marek Rogulski, Jakub Bielawski, Anish Kapoor, Andrzej Paruzel, Omar Amiralay, Slavs and Tatars, Allan Sonfist, Andrzej Mitan i Inn.]
        „Wspólnota tych, którzy nie mają ze sobą nic wspólnego” (…). (…) Luce Irigaray pyta: czy powietrze nie jest wszystkim, co zamieszkujemy jako śmiertelni? A zatem wspólnota śmiertelnych to właściwie wspólnota żyjących – oddychających, których istnienie warunkowane jest ścisłymi relacjami z otoczeniem, żadne bowiem życie nie trwa w izolacji”.
        Monika Bakke*
        [*Monika Bakke, Respiracja, w: Dotleniacz / Oxygenator, „Obieg” 2010/1-2, s.136.]
        Na Fot. Anna i Krystian Jarnuszkiewicz, Formy kinetyczne emitowane w Telewizji Polskiej
        między programami, poł. l.60 XX w. Fot.: Anna i Krystian Jarnuszkiewicz dzięki uprzejmości Artystów.
...
export const publications = [
    {
        ...
        'date': '2014',
        'description': `"Krystian Jarnuszkiewicz - Kamienny sen pod dębem", "Kwartalnik Rzeźby OROŃSKO" nr 1-2/2014, s.71-74: autorki: Elżbieta Grubba i Dorota Grubba, wypowiedzi  zacytowane i sugestie, korekty pierwszej wersji tekstu: Anna Jarnuszkiewicz i Krystian Jarnuszkiewicz. Redakcja wydawnicza: Halina Gajewska w Centrum Rzeźby Polskiej w Orońsku. Podziękowania dla Katarzyna Januszkiewicz - Córka Krystiana i Anny Jarnuszkiewicz, a także dla Patricka Komorowskiego + Galerii Pola Magnetyczne, Wiktora Gutta, Guni Nowik.

        Kamienny sen pod dębem to tytuł pracy Krystiana Jarnuszkiewicza oraz jego wystawy indywidualnej w Galerii „Pola Magnetyczne”
        w Warszawie (21 II – 10 V 2014), kuratorzy: Patrick Komorowski, Gunia Nowik, współpraca Anna Jarnuszkiewicz. Krystian Jarnuszkiewicz należy do fascynujących, a zarazem hermeneutycznych osobowości sztuki współczesnej. Jest twórcą niezwykle cenionym przez całe pokolenia artystów (Wiktor Gutt, Marek Sarełło, Jerzy Mizera, Grzegorz Kowalski, Barbara Falender, Krzysztof M. Bednarski i in.), także jego uczniów oraz niezależnych, często młodych odbiorców jego sztuki. Powołał i tworzy nadal wiele osobnych względem siebie i zadziwiających semantycznie, polimedialnych form, jak i ich autorskich fotograficznych interpretacji. Liczne z przestrzennych jego prac antycypowały kontekstualizm postmodernizmu oraz aspekty sztuki krytycznej i zaangażowanej, zarazem esencjonalnej, by przypomnieć obiekty: Obiata Xaweremu Dunikowskiemu (1975), Głowa św. Jana Chrzciciela (1975), Dydona (1975), Gromnica (1967), Ikona (1967), Generał (1979), Szachiści (1971) i inne prace, w tym Ziarno (1968) rzeźba, która współtworzyła Biennale Sztuki w Wenecji w 1972, eksponowana wtedy na międzynarodowym pokazie rzeźby współczesnej w Palazzo Ducale. [Rzeźba Dydona Krystiana Jarnuszkiewicza stała się inspiracją zbiorowej wystawy rzeźby współczesnej pt. Państwo Dydony (2010, PGS, Sopot i Galeria Nowych Mediów, Warszawa; zob. D. Grubba, „Państwo Dydony” – wystawa i wybrane problemy polskiej rzeźby współczesnej, Sopot–Pelplin 2010, PGS, Sopot, Bernardinum, Pelplin, kat. wyst., s. 1–9, 52–54,
        61–62, 80–81, 91, 123–124).]. Artysta uczestniczył w licznych innych ekspozycjach, projektach, także sympozjach sztuki w przestrzeni publicznej. Jest rówieśnikiem pokrewnych mu wybitnych osobowości, by przywołać operatora: Jerzego Wójcika (autora m.in. Matki
        Joanny od Aniołów). Niektóre nagradzane realizacje współtworzy
        z żoną Anną Jarnuszkiewicz, wybitną artystką, jak np. nowatorski projekt przeskalowanego horyzontalnego, portretu Chopina do otwartej przestrzeni w Londynie (III nagroda w 1974), czy pomnik Poznańskiego Czerwca – 1956 z Markiem Sarełło (I nagroda w 1980 z przeznaczeniem do realizacji), także przestrzeń upamiętnienia księdza Jerzego Popiełuszki w Górsku koło Torunia (z Grzegorzem Kowalskim, Maciejem Krysiakiem
        – realizowany w 2000). Anna Jarnuszkiewicz pisała o Krystianie: "Usłyszeć Go czasem można mówiącego o sztuce i swojej twórczości w pogawędkach z przyjaciółmi, objaśniającego myśli zawarte w jego pracach, a często bardzo emocjonalnie mówiącego o pracach przyjaciół i innych ulubionych twórców. Związały nas ze sobą studia odbywane we Wrocławiu, a potem całe nasze wspólne życie (…) dwojga twórców, którzy szli odrębnymi ścieżkami, ale też często spotykali się aby myśleć i pracować razem. Fascynował nas oboje problem monumentalnej
        formy rzeźbiarskiej w obszarze miasta, pejzażu. Stąd wiele wspólnych odpowiedzi na wyzwania konkursowe. Krystian jest, według mnie, przede wszystkim Poetą. Jego myśl biegnie zawsze ku poetyckiemu
        interpretowaniu rzeczywistości, przekraczając często ograniczenia warsztatu rzeźbiarskiego. Wielość możliwych rozwiązań w poszukiwaniu
        zadowalającej Go metafory, znaku plastycznego jest zawsze źródłem niezliczonych szkiców rysunkowych lub kolejnych wersji poszukiwanych...3. Parafrazując myśl Henryka Wicińskiego: w każdym załamaniu kołdry widzę formę, powiedziałabym, iż Krystian Jarnuszkiewicz w każdej żywej istocie, w napotkanym człowieku, w przedmiocie, a nawet w jego znaku indeksowym, widzi partnera do dyskusji i budowania możliwych sensów konstytuującej się właśnie nowej okoliczności. Charakteryzuje go nieprzerwane, a zarazem delikatne konstelowanie własnych form i Przedmiotów znalezionych jakby namnażanie semantycznych „kłączy”, ciągły „stan gotowości” do reagowania na to co w życiu właśnie się wydarza, lekkość, mądrość,
        emocjonalno-znaczeniowa głębia. Andrzej Pieńkos w Leksykonie sztuki polskiej XX wieku (1996) podkreślił: Krystian Jarnuszkiewicz (…) w wielu realizacjach wykracza zdecydowanie poza tradycyjne pojmowanie rzeźby jako obiektu (np. wykonana z Anną Jarnuszkiewicz „Menora” z 1988, m.in. spetryfikowany piasek i prawdziwe, płonące świece). Krystian Jarnuszkiewicz podkreśla, iż symbolika Menory odnosi się do żydowskich rytuałów w bożnicach położonych nad piaszczystym brzegiem polskich rzek. (...) W przestrzeni ekspozycji usytuowano m.in. stolik, budowany
        eksponowanymi horyzontalnie, najnowszymi „foto- -rzeźbami” Krystiana Jarnuszkiewicza. Jest wśród nich tytułowy Kamienny sen pod dębem, również Kołderka dla kamieni, Chmurka na krzyżyku, Dyrygent przedmiotów, Tulipan i kilkanaście innych, metafizycznych, a zarazem delikatnych, osobistych, zabawnych. Jakby przypominały o postulacie Waltera Benjamina z Twórcy jako wytwórcy (1934), iż dla myślenia nie ma lepszego startu niż śmiech (…) który daje większe pole (…) niż jątrzenie duszy. Ważnym punktem wystawy było odsłonięcie dotąd okrytego tajemnicą wątku życiorysu Krystiana Jarnuszkiewicza, który w 1969 r. przejmująco autentycznie zagrał główną rolę w kultowym dziś, nowofalowym filmie Struktura kryształu w reżyserii Krzysztofa Zanussiego, filmie aktualnie fascynującym badaczy młodego pokolenia. Dla zapewnienia sobie wolności aktorskiego doświadczenia, Krystian Jarnuszkiewicz wystąpił pod pseudonimem Jan Mysłowicz (od miasta Mysłowice, w którym się urodził). 17 kwietnia 2014 doszło w Galerii „Pola
        Magnetyczne” do spotkania po latach Krystiana Jarnuszkiewicza i Krzysztofa Zanussiego, który przyznał, iż osobowość tego artysty-introwertyka zainspirowała go do stworzenia Struktury kryształu.
        Zanussi powiedział też: aktor jest dla reżysera tym czym farba dla malarza. Cóż by namalował bez błękitu...?. 26 kwietnia 2014 r. Krystian Jarnuszkiewicz i Patrick Komorowski zaprosili na ich fascynujące
...

    {
        ...
        'author': 'Dorota Grubba-Thiede',
        'date': '2022',
        'description': `Dorota Grubba-Thiede, WOBEC „WROGOŚCINNOŚCI” I „ICONOCLASHU”. O wystawach, które mogły wesprzeć sublimacje globalnej przestrzeni, Kwartalnik Rzeźby Orońsko 2022_1-2, s.35-40, Red. Maciej Aleksandrowicz, Sekretarz Redakcji: Halina Gajewska.
        Dorota Grubba-Thiede: "W artykule przywołuję dwie międzynarodowe
        wystawy – a zarazem propozycje intelektualne i świadomościowe
        jakie wysunęli wybrani teoretycy sztuki we współpracy z plejadą
        twórczyń i twórców. W moim odczuciu – przy większej widoczności (np.
        w formie wystaw objazdowych, jak kiedyś Family of Man / Rodzina człowiecza [od 1955–1962 eksponowana w 38 krajach świata, kurator Edward Steichen, wpisana przez UNESCO
        na listę Pamięć świata] czy WACK! Art and the Feminist Revolution [od
        2007 w Museum of Contemporary Art w Los Angeles, kuratorka Connie Butler]), lub przez wprowadzenie tych zagadnień do szkolnictwa średniego
        i wyższego, mogłyby prawdopodobnie zapobiec aktualnym dramatycznym
        przemianom globalnym. W r o g o ś c i n n o ś ć – p o d e j -
        m o w a n i e o b c y c h 2010, Muzeum Sztuki 1 w Łodzi
        Kuratorzy tej wystawy, Jarosław Lubiak i Kamil Kuskowski, odnieśli się
    ...
    },
    {
        ...
        'author': 'Dorota Grubba-Thiede',
        'date': '2021',
        'description': `PRZERÓŻNE SPOSOBY [PACYFISTYCZNEGO] ORGANIZOWANIA, w: "Kody i Afordancje", wystawa sztuki współczesnej, kurator Marek Rogulski, współpraca Dorota Grubba, Bartosz Nowak, teksty, M. Rogulski, D. Grubba, Instytut Cybernetyki Sztuki Gdańsk 2021 Artystki/ Artyści: Roman Bromboszcz, Jowan Czerkas, Michał Gary Garnowski + Beata Oryl, Emilia Grubba/ Katarzyna Anna Jarnuszkiewicz + Krystian Jarnuszkiewicz, Łukasz Jeleniewski, Katarzyna Józefowicz, Andrzej Karolewicz, Magdalena Kieszniewska, Monika Krygier+ Stefan Krygier+ Władysław Strzemiński + Włodzimierz Pietrzyk "Christo", Przemek Kryszk, Michał Mazur, Maciek Możdżyński, Kasia Nawrocka, Andrzej Pater, Dorota Nieznalska, Bartosz Nowak, Bartłomiej Otocki, Pracownia EpiFiPiPsi, Marek Rogulski, Zuzanna Sadowa, Wojtek Sosnowski, Marek Wodzisławski, Andrzej Wojciechowski, Marek Zygmunt, Sofi Żezmer. Projekt wydawnictwa: Tomek Pawluczuk. Teksty: Marek Rogulski, Dorota Grubba, Współpraca z Artystkami, Artystami, Specjalne Podziękowania dla Osób współtworzących "K&A", + za wieloaspektowe Wsparcie: Pani Jadwiga Charzynska Dyrektor CSW Laznia 1/2 oraz Uczelnie AEH wŁodzi, ASP w Gdańsku, jak i Krzysztof Topolski, Iwona Teodorczuk-Możdżyńska, Paweł Możdżyński, Mi MiAestas, Janek Grubba, Wojtek Lesiecki, Adam Neuman, Państwowa Galeria Sztuki w Sopocie, wszystkie Osoby i instytucje kt. wsparly Projekt.27XI2021 Otwarcie, Perfo, Koncerty w ICS Instytut Cybernetyki Sztuki w Gdańsku Osowie`,
        'url': 'https://www.academia.edu/67769902/PRZER%C3%93%C5%BBNE_SPOSOBY_PACYFISTYCZNEGO_ORGANIZOWANIA_w_Kody_i_Afordancje_Kurator_Marek_Rogulski_wsp%C3%B3%C5%82praca_Dorota_Grubba_Bartosz_Nowak_Instytut_Cybernetyki_Sztuki_Gda%C5%84sk_2021'
    },
    {
        'title': '„Zapis równoległy” – przyczynek do badań nad twórczością i pedagogiką Andrzeja Wojciechowskiego oraz Witosława Czerwonki po 1981 r., w: Sztuka polska na Ziemiach Zachodnich i Północnych od 1981 r. do współczesności, red. Anna Markowska, K. Relig-Posłuszny, „Pamiętnik Sztuk Pięknych”, 2019, tom XIV',
        'author': 'Dorota Grubba-Thiede',
        'date': ' 2019',
        'description': `Dorota Grubba-Thiede, „Zapis równoległy” –  przyczynek do badań nad twórczością i pedagogiką Andrzeja Wojciechowskiego oraz Witosława Czerwonki po 1981 r. [artystów wywodzących się z Wrocławia], w: Sztuka polska na Ziemiach Zachodnich i Północnych od 1981 r. do współczesności [ Polish art in the Western and Northern territories from 1981 till the present ], red. Anna Markowska, Kinga Relig-Posłuszny,  rec. Eleonora Jedlińska, Jan W. Sienkiewicz, ISBN 978-83-956228-8-5, „Pamiętnik Sztuk Pięknych”, 2019, tom XIV, Wyd. Tako, Toruń 2019, s.27-41.`,
        'url': 'https://www.academia.edu/44840318/_Zapis_r%C3%B3wnoleg%C5%82y_przyczynek_do_bada%C5%84_nad_tw%C3%B3rczo%C5%9Bci%C4%85_i_pedagogik%C4%85_Andrzeja_Wojciechowskiego_oraz_Witos%C5%82awa_Czerwonki_po_1981_r_w_Sztuka_polska_na_Ziemiach_Zachodnich_i_P%C3%B3%C5%82nocnych_od_1981_r_do_wsp%C3%B3%C5%82czesno%C5%9Bci_red_Anna_Markowska_K_Relig_Pos%C5%82uszny_Pami%C4%99tnik_Sztuk_Pi%C4%99knych_2019_tom_XIV'
    },
    {
        'title': 'BOB-NOSA Uwagboe – metafory: ciało, grunt, fundament[alizm], "Sztuka i Krytyka" 2020/7-8 (94/95), red. Jerzy Malinowski, Grażyna Raj, Marcin Teodorczyk, rec. Anna Markowska, Jan W. Sienkiewicz, Warszawa 2020, s.60-68.',
        'author': 'Dorota Grubba-Thiede',
        'date': '2020',
        'description': `Dorota Grubba, Thiede, "BOB-NOSA Uwagboe – metafory: ciało, grunt, fundament[alizm]", "Sztuka i Krytyka" 2020/7-8 (94/95), red. Jerzy Malinowski, Grażyna Raj, Marcin Teodorczyk, rec. Anna Markowska, Jan W. Sienkiewicz, Warszawa 2020, s.60-68.

        Publikacja w recenzowanym wydawnictwie naukowym, o twórczości wybitnego nigeryjskiego artysty Boba Nosy Uwagboe, stanowiąca recenzję monograficznej ekspozycji pt. „Bob Nosa Uwagboe – TRANSIT” [Muzeum Narodowe w Gdańsku/ Oddział Sztuki Nowoczesnej Pałac Opatów w Oliwie, V-IX 2020]. Wystawa  była wynikiem kilkuletniej współpracy samego artysty i zaangażowanej kuratorki Małgorzaty Paszylki-Glazy. Twórczość zinterpetowałam w odniesieniu do wybranych teorii współczesnej humanistyki i sztuki.`,
        'url': 'https://www.academia.edu/44839755/BOB_NOSA_Uwagboe_metafory_cia%C5%82o_grunt_fundament_alizm_Sztuka_i_Krytyka_2020_7_8_94_95_red_Jerzy_Malinowski_Gra%C5%BCyna_Raj_Marcin_Teodorczyk_rec_Anna_Markowska_Jan_W_Sienkiewicz_Warszawa_2020_s_60_68'
    },
    // {
    //     'title': '',
    //     'author': '',
